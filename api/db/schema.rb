...
ActiveRecord::Schema.define(version: 2018_05_14_170024) do
  ...
  create_table "metadata", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["domain_id"], name: "index_metadata_on_domain_id"
  end
  ...
  create_table "strongs", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.text "phrase"
    t.datetime "parsed_at"
    t.bigint "domain_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["domain_id"], name: "index_strongs_on_domain_id"
  end

  add_foreign_key "headers", "domains"
  add_foreign_key "metadata", "domains"
  add_foreign_key "strongs", "domains"
end
